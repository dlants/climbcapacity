...
export function interpolate(
  ...
  interpolation: InterpolationOption<ParamName>,
): UnitValue | undefined {
  ...
  switch (interpolation.param) {
    case "repMax":
      ...
      return {
        unit: value.unit,
        value: brzycki_from_1rm(
          brzycki_to_1rm(value.value as number, startingRepMax),
          targetRepMax,
        ),
      } as UnitValue;
    case "edgeSize":
      ...
      return {
        unit: value.unit,
        value: edgesize_from_20mm(
          edgesize_to_20mm(value.value as number, startingEdgeSize),
          targetEdgeSize,
        ),
      } as UnitValue;
  }
